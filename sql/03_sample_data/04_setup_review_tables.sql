...
CREATE UNIQUE INDEX "VECTOR"."PRODUCTS_PK" ON "VECTOR"."PRODUCTS" ("ID");
ALTER TABLE VECTOR.PRODUCTS ADD CONSTRAINT PRODUCTS_PK PRIMARY KEY ( ID ) USING INDEX LOGGING;
...
ALTER TABLE VECTOR.REVIEWS ADD CONSTRAINT PROD_ID_FK FOREIGN KEY ( PROD_ID ) REFERENCES VECTOR.PRODUCTS ( ID ) ON DELETE CASCADE NOT DEFERRABLE NOVALIDATE;
...
ALTER TABLE VECTOR.STOCK ADD CONSTRAINT STOCK_PROD_ID_FK FOREIGN KEY ( PROD_ID ) REFERENCES VECTOR.PRODUCTS ( ID ) ON DELETE CASCADE NOT DEFERRABLE NOVALIDATE;
